...
function onesetMeter0() {
  ...
  $('.primary-piping .gd-txt7').css({top: '0%', left: '44.7%' })
  $('.primary-piping .gd-txt8').css({top: '0%', left: '59%' })
  $('.primary-piping .gd-txt9').css({top: '0%', left: '73%' })
  $('.primary-piping .gd-txt10').css({top: '17%', left: '44.7%' })
  $('.primary-piping .gd-txt11').css({top: '17%', left: '59%' })
  $('.primary-piping .gd-txt12').css({top: '17%', left: '73%' })
  $('.primary-piping .gd-txt13').css({top: '34%', left: '44.7%' })
  $('.primary-piping .gd-txt14').css({top: '34%', left: '59%' })
  $('.primary-piping .gd-txt15').css({top: '34%', left: '73%' })
  $('.primary-piping .gd-txt16').css({top: '51%', left: '44.7%' })
  $('.primary-piping .gd-txt17').css({top: '51%', left: '59%' })
  $('.primary-piping .gd-txt18').css({top: '51%', left: '73%' })
  $('.primary-piping .gd-txt19').css({top: '68%', left: '44.2%' })
  $('.primary-piping .gd-txt20').css({top: '68%', left: '58.4%' })
  $('.primary-piping .gd-txt21').css({top: '68%', left: '73%' })
